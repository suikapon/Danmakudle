...
if ($logueado) {
    ...
    if (!isset($_SESSION['elementoDiarioClasico']) || $_SESSION['elementoDiarioClasico'] != $idElementoHoy) {
        unset($_SESSION['intentosDiario']);
        $_SESSION['elementoDiarioClasico'] = $idElementoHoy;
    }
